...
Public Class Crystal_inas_grupal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crystal_inas_grupal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IPEM298.Crystal_inas_grupal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_inas_grupal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_inas_grupal = New Crystal_inas_grupal()
        rpt.Site = Me.Site
        Return rpt
    End Function
