...
Public Class Crystal_cert_alum_reg
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Crystal_cert_alum_reg.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IPEM298.Crystal_cert_alum_reg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_cert_alum_reg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_cert_alum_reg = New Crystal_cert_alum_reg()
        rpt.Site = Me.Site
        Return rpt
    End Function
