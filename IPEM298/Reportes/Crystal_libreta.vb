...
Public Class Crystal_libreta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IPEM298.Crystal_libreta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystal_libreta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystal_libreta = New Crystal_libreta()
        rpt.Site = Me.Site
        Return rpt
    End Function
